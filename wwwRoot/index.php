...
<meta name="keywords" content="bitpimps custom modifications micro rc radio remote control hobby car tomy bit char-g hobbico microsizer radioshack zipzap xmod kyosho mini-z overland i-waver tomica nikko miniature digi q indoor upgrade tutorial information photo image video race news forum gallery pullback paint body chassis gear motor suspension mosfet fet dual cell" />
<meta name="description" content="bitPimps.com offers the best entertainment, tutorials, modifications, information, etc. on all things related to Bit-Char G and similar R/C hobbies." />
...
<div id="container">
	<div id="header">
		...
		<div id="nav">
			<ul>
				<li><a href="index.php" title="Home" style="color:#FFDDAB; background-color:#929292;">Home</a></li>
	...
	<div id="container_body">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="rotmHeader"><img src="images/head_rotm.jpg" alt="Ride of the Month" name="img_head_rotm" width="223" height="25" id="img_head_rotm" /></td>
				<td width="491" rowspan="2" style="border-left:2px solid #000;"><img src="images/rotm/2007_06.jpg" alt="Ride of the Month" name="img_rotm" width="491" height="173" id="img_rotm" /></td>
			</tr>
			<tr>
				<td class="rotmCopy" valign="top">
					...
					This months winner: <strong>ibjamn</strong><br /><br />
					<em>- Word to BigBird</em>
				</td>
			</tr>
		</table>
		<div id="content">
				...
				<tr>
					<td valign="top" style="padding-right:30px;">
						...
						<p><strong>Want to talk with other members who share your interests in the R/C hobby?</strong><br />
							...
							adult attitude.</p>
						<p>bitPimps gives back to the community by running 
					...
					<td valign="top" style="padding-right:30px;">
						...
						<p>Looking to <a href="articles/category/electronics/">boost performance</a> with the infamous 
							MOSFET Mod or Dual Cell Mod? Want to <a href="articles/category/painting/">make your ride 
							look good</a> with some fresh paint? What about making it 
							<a href="articles/category/fabrication/">roll right</a> with some new wheels? 
							<a href="articles/index.php">You can find it all here.</a></p>
						<p>Want to see what can be done to your ZipZap SE or ZipZap MT? What about an original Bit Char-G 
							or Micosizer, or even a SuperSlick or some other clone? <a href="articles/index.php">This 
							is the place.</a></p>
					</td>
					<td valign="top">
						<p align="center"><a href="pages/phpGallery/index.php"><img src="images/head_galleries.jpg" / alt="bitPimps Galleries" name="bPGal" width="200" height="275" border="0" id="bPGal" /></a></p>
