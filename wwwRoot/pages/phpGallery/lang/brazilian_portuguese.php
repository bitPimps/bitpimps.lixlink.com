...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: https://coppermine.svn.sourceforge.net/svnroot/coppermine/trunk/cpg1.5.x/lang/brazilian_portuguese.php $
  $Revision: 8304 $
**********************************************/
...
$lang_translation_info['trans_name'] = 'Ricardo Pires';
$lang_translation_info['trans_email'] = 'ddoc9942@hotmail.com';
$lang_translation_info['trans_website'] = 'http://www.zicon.com.br/';
$lang_translation_info['trans_date'] = '2010-05-28';
...
$lang_meta_album_names['search'] = 'Resultado pesquisa de matrículas';
...
$lang_meta_album_names['favpics'] = 'Matrículas Favoritas';
$lang_meta_album_names['datebrowse'] = 'Pesquisar por data'; //cpg1.5

$lang_errors['access_denied'] = 'Você don\'t tem permissão para acessar esta pãgina.';
$lang_errors['invalid_form_token'] = 'A valid form token could not be found.'; //cpg1.5
$lang_errors['perm_denied'] = 'Você don\'t tem permissão para realizar esta operação.';
$lang_errors['param_missing'] = 'Script called without the required parameter(s).';
$lang_errors['non_exist_ap'] = 'O album/matrícula selecionado não existe!';
$lang_errors['quota_exceeded'] = 'Quota do disco excedida.'; //cpg1.5
$lang_errors['quota_exceeded_details'] = 'Você tem uma quota de espaço de [quota]K, seus arquivos atualmente usam [space]K, adicionando esta matrícula vai estar excedendo sua quota'; //cpg1.5
...
$lang_errors['offline_text'] = 'Galeria fora do ar - volte em breve';
...
$lang_common['edit_files'] = 'Editar Matrículas'; // cpg1.5
...
$lang_gallery_admin_menu['searchnew_lnk'] = 'Adicionar Matrículas em lote';
...
$lang_gallery_admin_menu['pictures_title'] = 'Organizar minhas matrículas';
$lang_gallery_admin_menu['pictures_lnk'] = 'Organizar Matrículas';
...
$lang_gallery_admin_menu['view_log_files_lnk'] = 'Ver histõrico das Matrículas'; // cpg1.5
...
$lang_gallery_admin_menu['pluginmgr_lnk'] = 'Gerenciar Plugin'; // cpg1.5
$lang_gallery_admin_menu['pluginmgr_title'] = 'Gerenciar Plugin'; // cpg1.5
...
$lang_gallery_admin_menu['keywordmgr_title'] = 'Gerenciar Palavras-Chave (Se a opção correspondente for ativada na configuração).'; // cpg1.5
...
$lang_cat_list['pictures'] = 'Matrículas';
...
$lang_thumb_view['user_on_page'] = '%d usáurios on %d página(s)';
...
$lang_thumb_view['zipdownload_copyright'] = 'Por favor respeitar os direitos autorais - Use os arquivos que baixados, como previsto pela Oficiala do 1º Serviço do Registro de Imóveis de Londrina'; // cpg1.5
...
$lang_img_nav_bar['prev_title'] = 'Ver matrícula anterior';
$lang_img_nav_bar['next_title'] = 'Ver próxima matrícula';
$lang_img_nav_bar['pic_pos'] = 'Matrícula %s/%s';
$lang_img_nav_bar['report_title'] = 'Reportar esta matrícula ao administrator';
$lang_img_nav_bar['go_album_end'] = 'Ir ao fim';
$lang_img_nav_bar['go_album_start'] = 'Ir ao inicio';

$lang_rate_pic['rate_this_pic'] = 'Avalie esta matrícula ';
...
$lang_rate_pic['already_voted'] = 'Já votou nesta matrícula.'; // cpg1.5
...
$lang_albmgr_php['confirm_delete2'] = 'Todas as matrículas e comentários serão perdidos!'; // js-alert
...
$lang_banning_php['error_user'] = 'Não é possível encontrar o usuãrio';
$lang_banning_php['error_specify'] = 'Você precisa especificar um nome de usuãrio ou um endereço IP';
...
$lang_banning_php['form_not_submit'] = 'The form hasn\'t been submitted - existem erros que precisam ser corrigidos primeiro!'; // cpg1.5
};
...
$lang_calendar_php['files'] = 'matrículas'; // cpg1.5
}
...
$lang_contact_php['registered_user'] = 'Usuãrio registrado'; // cpg1.5
