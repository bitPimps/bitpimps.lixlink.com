...
<!-- BEGIN header -->
        <tr>
                <td class="tableh1" width="80%"><b>Movie Files</b></td>
                <td class="tableh1" width="10%" align="center"><b>Albums</b></td>
                <td class="tableh1" width="10%" align="center"><b>Movies</b></td>
        </tr>
				<tr>
                <td class="tableb"><span class="catlink" style="font-size: 12px;"><a href="http://bitpimps.lixlink.com/pages/galleries/movies00.php"><b>bitPimps Theatre</b></a></span>Click here to see videos from the sick and twisted minds behind bitPimps!</td>
...
<!-- BEGIN catrow -->
        <tr>
                <td class="tableb"><span class="catlink" style="font-size: 12px;"><b>{CAT_TITLE}</b></span>{CAT_DESC}</td>
