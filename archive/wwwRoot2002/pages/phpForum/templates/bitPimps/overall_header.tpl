...
.bgBlueA			{ background: #9DC1DF; }
.bgBlueB			{ background: #39658A; }
.bgPage	{	background-image:   url(templates/bitPimps/images/bg_pattern.gif); background-repeat: repeat; }
...
<body bgcolor="{T_BODY_BGCOLOR}" text="{T_BODY_TEXT}" link="{T_BODY_LINK}" vlink="{T_BODY_VLINK}" class="bgPage" onLoad="MM_preloadImages('../../images/buttons/articles_over.gif','../../images/buttons/galleries_over.gif','../../images/buttons/links_over.gif','../../images/buttons/members_over.gif','../../images/buttons/home_over.gif')" />
