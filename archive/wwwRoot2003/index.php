...
<div id="viewContainer">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td rowspan="2" class="imgMain"><img src="images/page_images/491x173/rotm_home/2006_07.jpg" alt="" name="imgBody" width="491" height="173" id="imgBody" /></td>
		</tr>
		<tr>
		  <td valign="top" class="viewCopy">
				...
				This months winner: <strong>CaboWabo</strong><br /><br />
				- Word to BigBird
			</td>
	  </tr>
	</table>
