...
$lang_meta_album_names = array(
  ...
  'favpics'=> 'ფავორიტი ფაილები',  //cpg1.4
);
...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  ...
  'cookie_prefix' => 'ბმულის პრეფიქსი',
  'cookie_prefix_explanation' => 'ეს თქვენი ფორუმის ბმულის პრეფიქსი იქნება',
  ...
  'error_cookie_not_readible' => 'გალერეა ვერ კითხულობს ბმულს სახელით %s. შეასწორეთ მითითებული მნიშვნელობა %s პარამეტრისთვის, ან გადადით ფორუმის ადმინის პანელში და გადაამოწმეთ ბმულის გეზის მისაწვდომობა გალერეისთვის.',
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('ფავორიტებში ZIP ფაილების ჩამოტვირთვის უფლება', 'enable_zipdownload', 1, 'f=index.htm&amp;as=admin_general_zip-download&amp;ae=admin_general_zip-download_end'), //cpg1.4
...
// პროფილის დამტებითი ველები,  //cpg1.4
  ...
  array('ბმულის სახელი', 'cookie_name', 0, 'f=index.htm&amp;as=admin_cookie_name&amp;ae=admin_cookie_name_end'), //cpg1.4
  array('ბმულის გეზი', 'cookie_path', 0, 'f=index.htm&amp;as=admin_cookie_path&amp;ae=admin_cookie_path_end'), //cpg1.4
...
$lang_picinfo = array(
  ...
  'addFavPhrase'=>'ფავორიტები',
  'remFav'=>'ფავორიტებიდან ამოღება',
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  'ძირითადი კითხვები',
  array('რატომაა რეგისტრაცია აუცილებელი?', 'ადმინისტრაციას შეუძლია მოითხოვოს ან არ მოითხოვოს რეგისტრაცია.  რეგისტრაცია მონაწილეს დამატებით უფლებებს ანიჭებს: ფაილების ატვირთვა, ფავორიტი ფაილების საკუთარი სია, გამოსახულებათ შეფასებისა და კომენტირების შესაძლებლობა და ა.შ.', 'allow_user_registration', '1'),
  ...
  array('როგორ შევიდე სისტემაში?', 'გადადით პუნქტზე &quot;შესვლა&quot; დამიუთითეთ მონაწილის თქვენი სახელი და პაროლი და თუ გსურთ მონიშნეთ &quot;ავტომატური შესვლა &quot;, რათა მომავალში სისტემაში შესვლისას სახელისა და პაროლის მითითება ხელახლა აღარ დაგჭირდეთ.<br /><b>მნიშვნელოვანია: ამ საიტიდან ბმულების მიღება ნებადართული უნდა გქონდეთ.  მომავალში ამ საიტის ბმულები არ უნდა წაიშალოს რათა &quot;ავტომატური შესვლა&quot;.</b> კვლავ მუშაობდეს', 'offline', 0),
  ...
  array('რა არის ბმული?', 'ბმული გახლავთ მონაცემთა ჯგრო, რომელიც საიტიდან იგზავნება თქვენს კომპიუტერში შესანახად.<br />როგორც წესი, ეს ბმულები მონაწილეეებს საიტის დატოვების შემდეგ მასზე დაბრუნებისას სახელისა და პაროლის მითითების გარეშე ავტომატური შესვლის შესაძლებლობას აძლევს.', 'offline', 0),
  ...
  array('რა არის &quot;ჩემი ფავორიტები&quot;?', 'მონაწილეს ფავორიტი ფაილების თქვენს კომპიუტერში გამოგზავნილი ბმულების სახით შენახვის შესაძლებლობა აქვს.', 'offline', 0),
);
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
  ...
  'cookie_warning' => 'თქვენი ბრაუზერის გაფრთხილება არ მიიღოს სკრიპტის ბმულები', //cpg1.4
);
