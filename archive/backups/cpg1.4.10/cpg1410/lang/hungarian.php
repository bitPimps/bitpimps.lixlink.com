...
$lang_translation_info = array(
  ...
  'trans_name'=> 'Nagymáté Péter',
  'trans_email' => 'pepe@ludens.elte.hu',
  'trans_website' => 'http://www.beagle.hu',
  'trans_date' => '2006-02-25',
);
...
$lang_errors = array(
  ...
  'quota_exceeded' => 'Lemez terület kvóta túllépés<br /><br />A Te kvótád [quota] kB, jellenleg ennyi [space] kB foglalsz, ezzen kép feltöltésekor túlléped a kvótád.',
  'gd_file_type_err' => 'Amikor GD-könyvtárat használsz, a megengedett fájlformátum csak JPG vagy PNG .',
  'invalid_image' => 'A kép amit feltöltöttél sérült vagy a GD könyvtár nem kezeli a fáljformátumot',
  'resize_failed' => 'Nem lehet a képet átméretezni.',
  'no_img_to_display' => 'Nincs kép amit meg lehetne jeleníteni',
  'non_exist_cat' => 'A kiválasztott kategória nem létezik',
  'orphan_cat' => 'A kategóriának nem létezik szülője, futassd a kategória rendezőt a hiba kijavításához!',
  'directory_ro' => 'A könyvtár \'%s\' nem írható, a fájlt nem lehet törőlni',
  'non_exist_comment' => 'A kiválasztott megjegyzés nem létezik.',
  'pic_in_invalid_album' => 'A kép egy nem létező albumban van (%s)!?',
  'banned' => 'Jelenleg ki vagy zárva erről a weboldlaról',
  'not_with_udb' => 'Ez a funkció le van tiltva a Coppemine -ban , mert ez integrálva van egy fórom programmal.Tehát amit te szeretnél az nincs támogatva ezen konfigurációban vagy a funkciót a fórum program kezeli.',
  'offline_title' => 'Kikapcsolva',
  'offline_text' => 'Ez a Képgalléria kikapcsolt állapotban van - néz vissza később.', //cpg1.3.0
  ...
  'no_zip' => 'Nincs feltelepítve program a zip fájlok kezeléséhez.Keressd fel a rendszergazdát!',
...
$lang_main_menu = array(
  ...
  'toprated_title' => 'Mutasd meg a tegtöbb szavazatot kapott képeket', //cpg1.4
  'toprated_lnk' => 'Legjobb helyezett',
  'search_title' => 'Keresés a képtárban', //cpg1.4
  'search_lnk' => 'Keresés',
  'fav_title' => 'Ugrás a kedvencekhez', //cpg1.4
  'fav_lnk' => 'Kedvencek',
  'memberlist_title' => 'Mutassd a felhasználók listáját',
  'memberlist_lnk' => 'Felhasználók listája',
  'faq_title' => 'Gyakran felett kérdések(Frequently Asked Questions) a Képtárral kapcsolatban &quot;Coppermine&quot;',
  'faq_lnk' => 'GYIK',
);
...
$lang_user_admin_menu = array(
  'albmgr_title' => 'Albumain készítése és rendezése', //cpg1.4
...
$lang_cpg_debug_output = array(
  ...
  'copy_and_paste_instructions' => 'Ha segítségre van szükséged, akkor másold ki és küld el ezt a hibajelenség leírást a Coppermine Technikai Támogatásnak. Ügyelj arra, hogy jelszavak helyére *** -at írjál.<br />Megjegyzés: Ez csak egy információ,és nem jeleni azt, hogy baj van a képtáraddal.', //cpg1.4
...
$lang_version_alert = array(
  ...
  'no_stable_version' => 'Te most a Coppermine %s (%s) verziót használod, melyhez nem tartozik semilyen támogatás. Csak saját felelőségedre használd!', //cpg1.4
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
  ...
  'confirm_modifs' => 'Biztos, hogy végrehajtsuk ezen változtatásokat ?', //js-alert
  'no_change' => 'Nem történt változtatás!', //js-alert
  'new_album' => 'Új Album',
  'confirm_delete1' => 'Biztos, hogy törölni akarod?', //js-alert
  'confirm_delete2' => '\nAz öszses fájl és hozzászólás törlödni fog!', //js-alert
  'select_first' => 'Elöször válasz egy Albumot', //js-alert
...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  'title' => 'Kitíltott felhasználók', //cpg1.4
  ...
  'add_new' => 'Új letíltás hozzáadása', //cpg1.4
  'add_ban' => 'Hozzáadás', //cpg1.4
  'error_user' => 'Ismeretlen felhasználó', //cpg1.4
  'error_specify' => 'Meg kell adni felhasználónevet vagy IP címet!', //cpg1.4
  'error_ban_id' => 'Hibás tiltás azonosító!', //cpg1.4
  'error_admin_ban' => 'Saját magad nem tudod letíltani!', //cpg1.4
  'error_server_ban' => 'Ki akarod tiltani a saját szerverünket? Tán nem kéne...', //cpg1.4
  'error_ip_forbidden' => 'Ezt az IP címet nem lehet letíltani, mert ez egy belső cím!<br />Ha engedélyezni akarod a belső IP-k tíltását, változtasd meg a beállítást a <a href="admin.php">Konfiguráció</a> nál (csak akkor műkődik, ha a Képtár helyi hálózaton fut).', //cpg1.4
...
if (defined('BRIDGEMGR_PHP')) $lang_bridgemgr_php = array(
  ...
  'warning' => 'Figyelmeztetés:A varázsló használatával személyes adatok lesznek elküldve html ürlapokon keresztül . Csak a saját Pc-den futtasd (ne nyilvános gépen, mint pl Internet kávézó), és bizonyosodj meg arról, hogy a böngésződ kiűritette az ideiglenes tárolóját a használat után, különben mások is hozzáférhetnek az adataidhoz! ',
  'back' => 'vissza',
  'next' => 'következő',
  ...
  'no_action_needed' => 'Ennél a lépésnél nem kell semmit se csinálni, csak kattints a &quot;következő&quot;-re a folytatáshoz',
  'reset_to_default' => 'Beállítás alapértelmezetre',
  'choose_bbs_app' => 'Válassz alkalmazást amit összekötni kiváns a Coppermine-nal',
  ...
  'license_number' => 'Széria szám',
  'license_number_explanation' => 'Add meg a széria számot (ha létezik)',
  'db_database_name' => 'Adatbázis neve',
  'db_database_name_explanation' => 'Add meg az adatbázis nevét, melyet a fórum programod használ',
  'db_hostname' => 'Adatbázis szerver',
  'db_hostname_explanation' => 'Szervern neve,ahol a mysql adatbázis található. Általában &quot;localhost&quot;',
  ...
  'relative_path_of_forum_from_webroot_explanation' => 'A fórum relatív elérési útvonala a dokumentum gyökértől (Például: a fórum webcime http://www.sajátoldal.hu/forum/ , akkor írj &quot;/forum/&quot;-t ebbe a mezőbe)',
  'relative_path_to_config_file' => 'Relatív elérés a fórum konfigurációs fájljához',
  'relative_path_to_config_file_explanation' => 'A fórum relatív elérési útvonala a Coppermine könyvtárától  (pl.:. &quot;../forum/&quot; ha a fórum címe http://www.sajátoldal.hu/forum/  és a Coppermine címe http://www.sajátgép.hu/gallery/)',
  ...
  'use_standard_groups_explanation' => 'Használd a beépített felhasználói csoportokat (ajánlott). Ez az opcíó érvényteleníti az összes egyedi felhasználói csoport beállítást. Csak akkor tílts le ezt az opciót, ha TÉNYLEG tudod mit csinálsz!',
  ...
  'admin_group_explanation' => 'Administrátorok csoport ID-ja (Az alapértelmezett érték jó, csak akkor módosítsd, ha tudod mit csinálsz)',
  'banned_group' => 'Kitíltottak csoport',
  ...
  'use_post_based_groups_explanation' => 'Ennél a csoportnál meg van határozzva a beküldések száma (részletes beállítások) vagy az alap csoport (könnyű adminisztráció, ajánlott). Késöbb is megváltoztathatod.',
  'use_post_based_groups_yes' => 'igen',
  'use_post_based_groups_no' => 'nem',
  'error_title' => 'Háritsd el a hibát mielött tovább lépnél. Menj vissza az elötő képernyőre!',
  ...
  'bridge_enable_no' => 'letílt',
  'error_must_not_be_empty' => 'nem lehet üres',
  'error_either_be' => 'az egyiknek ennek %s vagy %s kell lennie',
  'error_folder_not_exist' => '%s nem létezik. Add meg a helyes adatok %s számára',
  'error_cookie_not_readible' => 'Coppermine nem tudja olvasni a %s nevű sütit. Add meg a helyes adatok %s számára , vagy menj a fórum administrációs felületére és ellenőrizd hogy a süti útvonala olvasható a Coppermin számára.',
  'error_mandatory_field_empty' => 'A mező %s nem lehet üres - töltsd ki a megfelelő adattal.',
  'error_no_trailing_slash' => 'A mezőben %s nem kell használni könytárlezárót (ferdevonal).',
  'error_trailing_slash' => 'A mezőben %s kell használni könytárlezárót (ferdevonal).',
  'error_db_connect' => 'Nem lehetséges kapcsolódni a MYSQL adatbázishoz. Itt a MYSQL hibaüzenete:',
  'error_db_name' => 'A Coppermine nem tudja létrehozni a kapcsolatot, mert nem találja az %s adatbázist. Ellenőrízd, hogy  %s adatbázisnév helyes. Itt a MYSQL hibaüzenet:',
  ...
  'recovery_explanation' => 'Ha administrálni akkarod a Coppermine képtár fórum integrációját, ahoz először rendszergazdaként kell bejelentkezni. Ha nem sikerül bejelentkezned, mert nem müködik a kötés megfelelően, akkor ezen az oldalon ki tudod kapcsolni az integrációt. A megadott a felhasználó és jelszó -val nem lépsz be csak kikapcsolod az integrációt. További infóért nézd meg a dokumentációt.',
  ...
  'recovery_wait_content' => 'Biztonsági okokból a script nem enged több probálkozást egymás után, tehát várnod kell egy keveset, míg újra megprobálhatod az azonosítást.',
  'wait' => 'Várakozás',
  'create_redir_file' => 'Átirányítási fájl létrehozása (ajánlott)',
  'create_redir_file_explanation' => 'Hogy a fórumba bejelentkezett felhasználókat átírányitsd a képtárba, szükség van erre a fájlra a fórum könyvtárban. Ha ezt az opciót kiválasztod akkor a kötés-kezelő létrehozza neked, vagy megadja a bemásolásra kész kódot, ha kézzel akarod létrehozni ',
  'browse' => 'böngészés',
);
...
if (defined('CATMGR_PHP')) $lang_catmgr_php = array(
  ...
  'update_create' => 'Kategória frissítés/létrehozzás',
  'parent_cat' => 'Szülő kategória',
  'cat_title' => 'A kategória címe',
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
  ...
  'save_cfg' => 'Új konfiguráció elmentése',
  'notes' => 'Megjegyzések',
  'info' => 'Információ',
  'upd_success' => 'Coppermin konfiguráció frissítve.',
  ...
  'pos_a' => 'Pozició szerint növekvő', //cpg1.4
  'pos_d' => 'Pozició szerint csökkenő', //cpg1.4
  ...
  'click_expand' => 'Kattintsd a szekció névre a kibontáshoz', //cpg1.4
  'expand_all' => 'Összes kibontása', //cpg1.4
  'notice1' => '(*) Ezen beállítások nem változnak, ha már vannak fájlok az adatbázisban.', //cpg1.4 - (relocated)
  'notice2' => '(**) A változtatások csak az ezután feltett fájlokra érvényesek, a régebbi fájlokra nem. Ha a már létező fájlokra is érvényre akarod juttani azt a &quot;<a href="util.php">Rendszergazda eszközök</a> (Képek átméretezése)&quot; menüvel tudod.', //cpg1.4 - (relocated)
  'notice3' => '(***) Minden log fájl angolul van írva.', //cpg1.4 - (relocated)
  'bbs_disabled' => 'Funkció letíltva, ha az integráció használva van', //cpg1.4
...
if (defined('ADMIN_PHP')) $lang_admin_data = array(
  ...
  array('Coppermine képtár url címe (no \'index.php\' or similar at the end)', 'ecards_more_pic_target', 0, 'f=index.htm&amp;as=admin_general_coppermine-url&amp;ae=admin_general_coppermine-url_end'), //cpg1.4
  array('Honlapod címe', 'home_target', 0, 'f=index.htm&amp;as=admin_general_home-url&amp;ae=admin_general_home-url_end'), //cpg1.4
  array('Kedvencek zippelt letőltésének engedélyezése', 'enable_zipdownload', 1, 'f=index.htm&amp;as=admin_general_zip-download&amp;ae=admin_general_zip-download_end'), //cpg1.4
  ...
  array('Segítség ikonos engedélyezése (Segítség csak Angolul érhető el.)','enable_help',9, 'f=index.htm&amp;as=admin_general_help&amp;ae=admin_general_help_end'), //cpg1.4
  array('Kulcsszó kiválasztos keresés engedélyezése','clickable_keyword_search',14, 'f=index.htm&amp;as=admin_general_keywords_start&amp;ae=admin_general_keywords_end'), //cpg1.4
  ...
  array('Mutassa az &quot;alapértelmezésre&quot; a nyelvi menűben', 'language_reset', 1, 'f=index.htm&amp;as=admin_language_reset&amp;ae=admin_language_reset_end&amp;top=1'), //cpg1.4
  ...
  array('Mutassa az &quot;Alapértelmezésre &quot; a téma választék menüben', 'theme_reset', 1, 'f=index.htm&amp;as=admin_theme_theme_reset&amp;ae=admin_theme_theme_reset_end'), //cpg1.4
  ...
  array('bbcode-Segítség mutatása', 'show_bbcode_help', 1, 'f=index.htm&amp;as=admin_theme_bbcode&amp;ae=admin_theme_bbcode_end&amp;top=1'), //cpg1.4
  array('Mutassa a pipere részt a témában ami XHTML vagy CSS ben írodott?','vanity_block',1, 'f=index.htm&amp;as=vanity_block&amp;ae=vanity_block_end'), //cpg1.4
  ...
  array('A megtekintések számának mutatása az indexkép alatt', 'views_in_thumbview', 1, 'f=index.htm&amp;as=admin_thumbnail_display_views&amp;ae=admin_thumbnail_display_views_end'), //cpg1.4
  array('A hozászólások számának mutatása az indexkép alatt', 'display_comment_count', 1, 'f=index.htm&amp;as=admin_thumbnail_display_comments&amp;ae=admin_thumbnail_display_comments_end'), //cpg1.4
  array('A feltöltő nevének mutatása az indexkép alatt', 'display_uploader', 1, 'f=index.htm&amp;as=admin_thumbnail_display_uploader&amp;ae=admin_thumbnail_display_uploader_end'), //cpg1.4
  //array('A deltöltő Rendszergazda nevének mutatása az indexkép alatt ', 'display_admin_uploader', 1, 'f=index.htm&amp;as=admin_thumbnail_display_admin_uploader&amp;ae=admin_thumbnail_display_admin_uploader_end'), //cpg1.4
  ...
  array('A szükséges szavazatok száma a megjelenjenéshez  \'A legtöbb szavazatot kapottak\'-listájában', 'min_votes_for_rating', 0, 'f=index.htm&amp;as=admin_thumbnail_minimum_votes&amp;ae=admin_thumbnail_minimum_votes_end'), //cpg1.4
  ...
  array('Film szalag mutatása', 'display_film_strip', 1, 'f=index.htm&amp;as=admin_image_comment_filmstrip_toggle&amp;ae=admin_image_comment_filmstrip_toggle_end'), //cpg1.4
  array('Fájlnév mutatása a Filmszalag alatt', 'display_film_strip_filename', 1, 'f=index.htm&amp;as=admin_image_comment_display_film_strip_filename&amp;ae=admin_image_comment_display_film_strip_filename_end'), //cpg1.4
  ...
  array('Diavetítés időköze ezredmásodpercben (1 mp = 1000 ezredmásodperc)', 'slideshow_interval', 0, 'f=index.htm&amp;as=admin_image_comment_slideshow_interval&amp;ae=admin_image_comment_slideshow_interval_end'), //cpg1.4
  ...
  array('Legnagyobb szélessége vagy magassága a közbenső képnek vagy videónak <a href="#notice2" class="clickable_option">**</a>', 'picture_width', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_intermediate_dimension&amp;ae=admin_picture_thumbnail_intermediate_dimension_end'), //cpg1.4
  ...
  array('Legnagyobb szélessége vagy magassága a feltölthető képnek vagy videónak (képpontban)', 'max_upl_width_height', 0, 'f=index.htm&amp;as=admin_picture_thumbnail_max_upload_dimension&amp;ae=admin_picture_thumbnail_max_upload_dimension_end'), //cpg1.4
  ...
  array('Magán album ikon mutatása látogatóknak?','show_private',1, 'f=index.htm&amp;as=admin_picture_thumb_advanced_private_icon_show&amp;ae=admin_picture_thumb_advanced_private_icon_show_end'), //cpg1.4
  ...
  array('Megengedett video formátumok', 'allowed_mov_types',0, 'f=index.htm&amp;as=admin_thumbs_advanced_movie&amp;ae=admin_thumbs_advanced_movie_end'), //cpg1.4
  ...
  array('Az ImageMacick program \'convert\'eszköz helye (pl. /usr/bin/X11/)', 'impath', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_im_path&amp;ae=admin_picture_thumb_advanced_im_path_end'), //cpg1.4
  ...
  array('Parancs sori opciók az ImageMagick számára', 'im_options', 0, 'f=index.htm&amp;as=admin_picture_thumb_advanced_im_commandline&amp;ae=admin_picture_thumb_advanced_im_commandline_end'), //cpg1.4
  ...
  array('Rendszergazda értesítése Emailban a regisztrációról', 'reg_notify_admin_email', 1, 'f=index.htm&amp;as=admin_registration_notify&amp;ae=admin_registration_notify_end'), //cpg1.4
  ...
  array('Rendszergazda értesítése jóváhagyásra váró feltöltésekről', 'upl_notify_admin_email', 1, 'f=index.htm&amp;as=admin_approval_notify&amp;ae=admin_approval_notify_end'), //cpg1.4
...
// custom profile fields,  //cpg1.4
  ...
  Használd a 6. mezőt a hosszú bejegyzéseknek, mint pl. életrajz.', //cpg1.4
  ...
  'Saját mezők a képek leírására (hagyd üresem, ha nemhasználod).',
  ...
  array('Kimenő levélkiszolgáló (smtp) , ha üres akkor a sendmail lesz használva', 'smtp_host', 0, 'f=index.htm&amp;as=admin_email&amp;ae=admin_email_end'), //cpg1.4
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'check_all' => 'Összes bejelőlése',
  'uncheck_all' => 'Összes bejelőlés törlése',
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'com_added' => 'A hozzászólásod feljegyezvtük',
  'alb_need_title' => 'A képalbumnak címet kell adni!',
  'no_udp_needed' => 'Nincs szükség frissítésre.',
  'alb_updated' => 'A képalbumot frissítetük',
  'unknown_album' => 'A kiválasztott képalbum nem létezik, vagy nincs jogod képet feltőlteni bele',
  'no_pic_uploaded' => 'Nem lett fájl feltöltve!<br /><br />Ha netán ki volt választva kép feltöltése, akkor ellenőrizd, hogy engedélyve van-e a feltöltés...',
  'err_mkdir' => 'Hiba a %s könyvtár létrehozásakor!',
  'dest_dir_ro' => 'A cél könyvtár %s nem írható a program által!',
  'err_move' => 'Lehetetlen %s átmozgatni %s ebbe a könyvtárba!',
  ...
  'com_author_error' => 'Ezt a becenevet egy regisztrált tag használja, jelentkezz be vagy használj másik nevet.', //cpg1.4
);
...
if (defined('DELETE_PHP')) $lang_delete_php = array(
  ...
  'alb_del_success' => 'Album &laquo;%s&raquo; törölve', //cpg1.4
  ...
  'err_empty_groups' => 'Nincs egyetlen csoport-tábla sem vagy a csoport tábla üres!', //cpg1.4
  'comment_deleted' => 'Hozzászólás sikeresen törölve',
  'npic' => 'Kép', //cpg1.4
  'pic_mgr' => 'Kép-kezelő', //cpg1.4
...
$lang_picinfo = array(
  ...
  'ExposureProgram' => 'Expoziciós program', //cpg1.4
  'Flash' => 'Vaku', //cpg1.4
  'MeteringMode' => 'Mérési mód', //cpg1.4
  'ExposureTime' => 'Expoziciós idő', //cpg1.4
  'ExposureBiasValue' => 'Expoziciós előlállítás', //cpg1.4
  ...
  'ExifInteroperabilityOffset' => 'Exif együttmükődési ellenérték', //cpg1.4
  'FileSource' => 'Fájl forrás', //cpg1.4
  'SceneType' => 'Színhely tipus', //cpg1.4
  'CustomerRender' => 'Ügyfél beállítás', //cpg1.4
  'ExposureMode' => 'Expoziciós mód', //cpg1.4
  'WhiteBalance' => 'Fehér engyensúly', //cpg1.4
  'DigitalZoomRatio' => 'Digitális zoom arány', //cpg1.4
  'SceneCaptureMode' => 'Táj felvételi mód', //cpg1.4
  'GainControl' => 'Nyereség kontrol', //cpg1.4
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  ...
  'view_ecard_plaintext' => 'Hogy megtekintsd ezt a képeslapot, másold ki és illesztd be ezt az url-ta böngésződ címsorába:', //cpg1.4
...
if (defined('REPORT_FILE_PHP') || defined('DISPLAYREPORT_PHP')) $lang_report_php =array(
  ...
  'invalid_email' => '<b>Figyelem</b> : Hibás Emaol cím!', //cpg1.4
  ...
  'view_report_plaintext' => 'Hogy megtekintsd ezt a jelentést, másold ki és illesztd be ezt az url-ta böngésződ címsorába:', //cpg1.4
  ...
  'other' => 'másik', //cpg1.4
  'refers_to' => 'Kép jelntése neki', //cpg1.4
  'reasons_list_heading' => 'A jelntés oka:', //cpg1.4
  'no_reason_given' => 'Nincs indíték megadva', //cpg1.4
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
  ...
  'approve' => 'Kép jováhagyása',
  'postpone_app' => 'Elhalasztott jováhagyás',
  'del_pic' => 'Kép törlése',
  'del_all' => 'Összes kép törlése', //cpg1.4
  'read_exif' => 'EXIF-Adatok újraolvasásása',
  'reset_view_count' => 'Nézetségi számláló nullázása',
  'reset_all_view_count' => 'Az összes nézetségi számláló nullázása', //cpg1.4
  ...
  'rename_failed' => "Az átnevezés'%s' erről '%s'erre nem sikerült.", //cpg1.4
  'src_file_missing' => "A forrásfájl '%s' hiányzik.", // cpg 1.4
  'mime_conv' => "Nem lehet átkonvertálni '%s' erről '%s' erre",//cpg1.4
  'forb_ext' => 'Tiltott fájl kiterjesztés.',//cpg1.4
);
...
if (defined('FAQ_PHP')) $lang_faq_php = array(
  'faq' => 'Gyalran Ismételt Kérdések (Frequently Asked Questions)',
  'toc' => 'Tárgymutató',
  'question' => 'Kérdés: ',
  'answer' => 'Válasz: ',
);
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('Hogyan tudok regisztrálni?', 'Kattints a &quot;Registráció&quot; -ra és töltsd ki a szükséges mezőket (és az opciónálisokat is, ha akarod).<br />Ha a rendszergazda engedélyezte az Email aktiválást, akkor az adatok elfogadása után kapsz egy email üzenetet arra a címre , melyet a regisztrációkor megadtál,melyben utasításokat találsz arra, hogy hogyan aktíváld a tagságodat. Hogy be tudj jelentkezni szükséges aktivált tagság.', 'allow_user_registration', '1'),
  ...
  array('Miért nem tudok bejelentkezni?', 'Regisztráltad magadat? Előfordulhat, hogy a képtár látogatása regisztrációhoz kötött. Ki lettél tiltva a Képtárról (ebben az esetben egy üzenet jelenik meg)? Lépj kapcsolatba a webmesterrel, vagy az Adminisztrátorral, hogy miért tiltottak le. Ha regisztrálva vagy, és nem vagy kitiltva az oldalról, akkor ellenőrizd, hogy nem gépelted-e el a nevet, vagy a jelszót. Ellenőrizd kétszer is, mivel legtöbbször ez a hiba. Ha a hiba még mindig fennáll, akkor lépj kapcsolatba az Adminisztrátorral, megadva a hiba pontos okát.', 'offline', 0),
  array('Mit tegyek, ha elfelejtettem a jelszavam?', ' Ha van &quot;Elfejetettem ajelszót&quot; link akkor használd.Más esetekben keressd meg a rendszergazdát', 'offline', 0),
  //array('Mit tegyek ha meg akarom változtatni az Email címemet?', 'Egyszerüen jelentkezz be és menj a &quot; saját profil&quot;-ra', 'offline', 0),
  array('Hogy vehetem fel a képet a &quot;Kedvenceim&quot; közé?', 'Kattints a képre , majd kattints a&quot;Kép-információ&quot;-ra (<img src="images/info.gif" width="16" height="16" border="0" alt="Kép-információ" />); menj az adatok aljára és kattints a &quot;Kedvencek hozzáadása&quot;-ra.<br />A rendszergazda engedélyezheti alapból a képinformációkat.<br />Fontos: A sütiknek engedélyezve kell lennie.', 'offline', 0),
  array('Hogy tudom véleményezni a képet?', 'Kattints az indexképre és a kép alján válasz neki helyezést.', 'offline', 0),
  ...
  array('Hova tudok képet feltölteni?', 'A saját albumaid közül bármelyikbe amelyek a &quot;Saját képtár&quot;-od ban találhatóak ', 'allow_private_albums', 0),
  ...
  array('Hogy tudom megakadályozni illetve módosítani, hogy ki nézze meg az albumaim?', 'Ehhez rendszergazda módban kell lenni.<br />Meny a &quot; Saját album módosítása&quot; menübe. Az &quot;Album frissítése&quot; listában válaszd ki a módoítani kivánt albumot.<br />Itt tudsz nevet,leírást, indexképet,megtekintés korlátozást és véleményezés korlátozást változtatni.<br />A végén kattints az  &quot;Album frissítés&quot; -re.', 'allow_private_albums', 0),
  array('Mik azok a sütik?', 'A sütik egy kisméretü text fájlok , melyet a webszerver küld a számítógépednek.<br /> ', 'offline', 0),
  array('Hogyan használhatnám ezt a programot a saját weboldalomon?', 'A Coppermine egy szabadon felhasználható multimédiás Képtár,mely a GNU alatt lett kiadva. Az összes szolgáltatása le van fordítva különböző platformokra. Láttogasd meg a  <a href="http://coppermine.sf.net/">Coppermine weboldalát</a> további információkért és a program letöltésért .', 'offline', 0),

  'Navigálás az oldalon',
  array('Mi az &quot;Album -listat&quot;?', 'Itt tudod megnézni az egész képtárat, minden albumhoz tartozik link. Ha nem vagy benne valamelyik képtárban akkor a képtárak listáját látod.', 'offline', 0),
  ...
  array('Mi a &quot;Legujabb feltöltések&quot;?', 'Itt lehet megnézni az utolsó feltöltéseket.', 'offline', 0),
  array('Mi a &quot;Legujabb hozzászólások&quot;?', 'itt lehet megnézni a legújabb hozászólásokat, melyeket a felhasználók beküldtek .', 'offline', 0),
  array('Mi a &quot;Legtöbbet nézet&quot;?', 'Itt lehet megnézni a legtöbbet nézet képet az összes kép közül.', 'offline', 0),
  array('Mi a &quot;Legtöbb szavazatot&quot;?', 'Ez a szolgáltatás mutatja a felhasználók által legjobban kedvelt képeket, megjelenítve az átlagos osztályzatot (pl. 5 néző ad  <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />: -ot akkor a kép átlagos osztályzata <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> ;Ha 5 néző osztályozza a képet  1 -től 5 ig (1,2,3,4,5) akkor az átlag: <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> .)<br />A helyezés skála  <img src="images/rating5.gif" width="65" height="14" border="0" alt="super" /> (legjobb)-tól a <img src="images/rating0.gif" width="65" height="14" border="0" alt="sehr schlecht" /> (legrosszabb) -ig terjed.', 'offline', 0),
...
if (defined('FORGOT_PASSWD_PHP')) $lang_forgot_passwd_php = array(
  ...
  'email_sent' => 'A felhasználó nevet és jelszót tartalmazó levél el lett küldve %s címre.', //cpg1.4
  'verify_email_sent' => 'Az Email elküldve %s címre. Kérjül nézd meg a postaládádat a folyamat befejezéséhez.', //cpg1.4
  'err_unk_user' => 'Nem létező felhasználó!',
  'account_verify_subject' => '%s - Új jelszót kér', //cpg1.4
  'account_verify_body' => 'Te most új jelszót kértél. Ha azt akarod , hogy az új jelszót elküldjük kövessd a következő linket:

%s', //cpg1.4
  'passwd_reset_subject' => '%s - Az új jelszavad', //cpg1.4
  'passwd_reset_body' => 'Itt az új jelszó amit kértél:
Felhasználónév: %s
Jelszó: %s
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'explain_guests_greyed_out_text' => 'Nem tudod változtatni ezt a tulajdonságot, mert kikapcsoltad a  &quot;Vendég felhasználók engedélyezése&quot; opciót a Coppermine-Konfigurációs oldalán. Az összes vendég (A %s csoport tagjai) semmit sem tudnak csinálni a bejelentkezésen kivűl; tehát a csoportbeállítások nem érvényesek rájuk.', //cpg1.4
...
$lang_list_categories = array(
  'home' => 'Képtár',
  'stat1' => '<b>[pictures]</b> kép <b>[albums]</b> Albumban és <b>[cat]</b> Kategoria <b>[comments]</b> Hozzászólással, <b>[views]</b> szor megtekintve',
  'stat2' => '<b>[pictures]</b> kép <b>[albums]</b> Albumban, <b>[views]</b> szor megtekintve',
  'xx_s_gallery' => '%s Képtára',
  'stat3' => '<b>[pictures]</b> kép <b>[albums]</b> Albumban <b>[comments]</b> Hozzászólással, <b>[views]</b> szor megtekintve'
);
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
  ...
  'enter_login_pswd' => 'Add meg a felhasználónevedet és jelszavad a bejelentkezéshez',
  'username' => 'Felhasználó név',
  'password' => 'Jelszó',
  'remember_me' => 'Emlékezz rám',
  'welcome' => 'Üdvözölek %s ...',
  'err_login' => '*** Nem sikerült bejelentkezned. Próbáld újra ***',
  'err_already_logged_in' => 'Már be agy jelentkezve!',
  'forgot_password_link' => 'Elfelejtettem a jelszavam',
  'cookie_warning' => 'Figyelmeztetés: A böngészöd nem fogadja el a sütiket', //cpg1.4
);
...
if (defined('PICMGR_PHP')) $lang_picmgr_php = array(
  ...
  'no_change' => 'Nem tudsz változtatni semmit sem!', //cpg1.4
  'no_album' => '* Nincs Album *', //cpg1.4
  'explanation_header' => 'A saját sorrend amit itt beállítasz csak ehhez a felhasználóhoz tartoznak', //cpg1.4
  'explanation1' => 'A rendszergazda be tudja állítani az alapértelmezett sorrendet növekvőre vagy csökkenőre (ez mindenkire vonatkozik akik nem tudják saját maguk beállítani)', //cpg1.4
  'explanation2' => 'A felhasználó válaszhat a növekvő vagy csökkenő sorrend közt az indexkép nézetben', //cpg1.4
);
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
  'already_rated' => 'Bocsi, de már osztályoztad a képet',
...
<br />
Beleegyezek, hogy nem küldök sértegető, obszcén, vulgáris, rágalmazó, gyűlöletkeltő, támadó, vagy bármely más olyan tartalmat, illetve anyagot, mely törvényt sért. Sem olyan anyagot, mely ellentétes az általános közízléssel, mivel ez egy nyilvános Képtár. A fentiek megsértése azonnali és végleges törlést von maga után.
Elfogadom, hogy a Képtár webmesterének, az Adminisztrátornak  jogában áll eltávolítani, szerkeszteni a hozzászólásaimat, vagy törölni az általam felrakott képeket, amennyiben úgy ítélik meg hogy ez szükséges. Mint felhasználó, elfogadom, hogy néhány, általam megadott információ tárolásra kerül a Képtár adatbázisában. Ezek az adatok semmilyen módon nem kerülnek ki egy harmadik félhez, de az Adminisztrátorok sem tudnak felelősséget vállalni, egy esetleges "hacker-támadásra".<br />
<br />
A Képtár "cookie"-kat (sütiket) használ, hogy adatokat tároljon a felhasználó számítógépén, de egyik sem tartalmaz személyes adatokat, melyek a regisztrációnál kerültek megadásra: a cookie-k pusztán technikai szempontból szükségesek. A megadott emailcím csak a regisztráció (és új jelszó) érvényesítésénél kerül felhasználásra.
<br />
<br />
...
$lang_register_php = array(
  ...
  'err_invalid_email' => 'Nme érvényes Email cím',
  ...
  'failed_sending_email' => 'A regisztráció megerősítése levél nem lett elküldve',
  'thank_you' => 'Köszönjük a regisztrációt.<br /><br />Az Emailt a felhasználói azonosító aktíválásának mikéntjével elküldtük a megadott címre.',
  ...
  'apply_modif' => 'Módosítások jováhagyása',
  'change_pass' => 'Jelszó változtatás',
  ...
  'thank_you_admin_activation' => 'Köszönjük.<br /><br />Az azonosító aktíválási kérelem el lett küldve a rendszergazdának.Email-ben értesítünk az elfogadásról.', //cpg1.4
  'acct_active_admin_activation' => 'Az azonosító aktív, email elküldve a felhasználónak.', //cpg1.4
  'notify_user_email_subject' => '%s - Aktívációs értesitő', //cpg1.4
);

$lang_register_confirm_email = <<<EOT
Köszönjük a regisztrációját {SITE_NAME} -ra

Az Ön felhasználóneve : "{USER_NAME}"
Az Ön jelszava : "{PASSWORD}"

Az azonositó aktíválásához szükséges, hogy rákattintson az alábbi linkre, vagy másolja be a böngészőjébe.
...
A(z) "{USER_NAME}" nevű felhasználó regisztrálta magát a képtáradba.
...
A bejelentkezéshez erre az <a href="{SITE_LINK}">{SITE_LINK}</a> oldalra használd a(z) "{USER_NAME}" felhasználónevet.
...
$lang_search_php = array(
  ...
  'keyword_msg' => 'A fenti lista nem tartalmaz mindent - Nincsenek benne a képek címeinek és leírásainak szavai. Probáld meg a teljes szövegben való keresésést.',  //cpg1.4
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  'page_title' => 'Új képek keresésése',
  'select_dir' => 'Válassz könyvtárat',
  'select_dir_msg' => 'Ez a szólgáltatás lehetővé teszi egynél több kép egyidejü feltöltését FTP-n keresztül.<br /><br />Válasz könyvtárat ahova feltölteni kivánsz.', //cpg1.4
  'no_pic_to_add' => 'Nem lett hozzáadva semmi sem',
  'need_one_album' => 'Legalább 1 albumnak léteznie kell a szolgáltatás használatához',
  'warning' => 'Figyelem',
  'change_perm' => 'A program nem tudd írni a könyvtárba. Szükséges megváltoztatnod a jogosultságokat  (chmod) 755 -ra vagy 777 re, mielött fájlokat adnál hozzá!',
  ...
  'notes' =>  '<ul>'.
    ...
    '<li><b>DP</b> : jelentése - a kép már szerepel az adatbázisban többször'.
    ...
    '<li>Ha OK, DP, PB \'Jelek\' nem jelennek meg, kattints a törött fájlra, hogy meglásd a PHP által adott hibaüzenetet'.
    '<li>Ha a böngésződ időtúllépést jelezz kattints a újratöltés gombra'.
    '</ul>',
  'select_album' => 'válassz Albumot',
  'check_all' => 'Összes kiválasztása',
  'uncheck_all' => 'Összes kiválasztás törlése',
  'no_folders' => 'Nincs könyvtár létrehozva az "albums" könyvtáron belül. Ellenőrizd, hogy létre lett-e hozva legalább 1 felhasználói könyvtár "albums" alatt és lett-e fájl feltöltve oda. Tilos feltöltésre használni a "userpics" vagy az "edit" könyvtárakat, e könyvtárak fenntartva vannak belső használatra.', //cpg1.4
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'cust_instr_1' => 'Választhatsz egyedi feltölő dobozokat, de nem választhatsz többet az alább értékeknél.',
  ...
  'reg_instr_4' => 'Ha az URI/URL-feltöltő módot használod,, akkor add meg a kép útvonalát ilyen formában mint pl. \'http://www.sajat.hu/képek/példa.jpg\'',
  ...
  'no_upload' => 'Nme történt feltöltés.',
  ...
  'http_503' => '503 Szolgáltatás nem elérhető',
  'MIME_extraction_failure' => 'Ismeretlen MIME tartalom.',
  'MIME_type_unknown' => 'Ismeretlen MIME-Tipus',
  ...
  'success' => '%s db feltöltés sikeress.',
  'add' => 'Kattints a  \'tovább\'-ra, a képek albumhoz adásába.',
  ...
  'place_instr_2' => 'További fájlok elhelyezéséhez kattints \'folytatás\'-ra!',
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
  ...
  'change_primary_membergroup' => 'Elsödleges csoport beállítása', //cpg1.4
  ...
  'alert_no_selection' => 'Elöször válassz egy felhasználót!', //cpg1.4 //js-alert
  'password' => 'Jelszó', //cpg1.4
  'select_group' => 'Válasz csoportot!', //cpg1.4
...
'Az eredeti és a köztes képek törlése üres helyért', //cpg1.4
'Árva hozzászólások törlése', //cpg1.4
'A fájlméretek újraolvasása (ha kézzel szerkeszetük a képet)', //cpg1.4
'Megtekintési számláló nullázása', //cpg1.4
'phpinfo mutatása', //cpg1.4
...
$lang_util_php = array(
  ...
  'thumbs_wait' => 'Indexképek frissítése vagy a a képek átméretezése folyik, kérem várjon...',
  'thumbs_continue_wait' => 'tovább a indexképek frissítéséhez vagy az átméretezéshez...',
  'titles_wait' => 'Címek frissítése, kérem várjon...',
  'delete_wait' => 'Címek törlése, kérem várjon...',
  'replace_wait' => 'Az eredeti képek felülírása az átméretezett képekkel, kérem várjon...',
  ...
  'update_option' => '(Probáld beállítani ezt az időpontot kevesebbre, ha időtúllépést tapasztalsz)',
  'filename_title' => 'Fájlnév &rArr; képcím',
  'filename_how' => 'Mi legyen a fájnévvel',
  'filename_remove' => 'A .jpg kiterjesztés törlése és kicserélése _ (aláhuzzás)-ra',
  ...
  'delete_intermediate_explanation' => 'A köztes képek törlése.<br />Használd ezt lemez terület felszabadításra, ha a \'köztes kép létrehozzása\' opció letíltva a beállításoknál.', //cpg1.4
  ...
  'deleting_intermediates' => 'Köztes képek törlése , kérem várjon...', //cpg1.4
  'searching_orphans' => 'Árva fájlok keresése, kérem várjon...', //cpg1.4
  'select_album' => 'Válasz Albumot',
  'delete_orphans' => 'A hiányzó képekhez tartozó hozzászólások törlése', //cpg1.4
  'delete_orphans_explanation' => 'Ez az opció azonosítja és lehetővé teszi a törlésüket a képekhez nem tartozó hozzászólásoknak.<br />Az összes albumot ellenőrize.', //cpg1.4
  ...
  'orphan_comment' => 'Árva hozzászólás találva',
  'delete' => 'törlés',
  ...
  'update_db_explanation' => 'Ha visszamented a Coppermine program fájlait, vagy újabb verzióra cserélted, akkor ajánlott egyszer lefutattni a frissítést, hogy a megfelelő táblák létrejöjenek, illetve helyes értékeket tartalmazzanak.',
  'view_log' => 'Naplófájl megtekintése', //cpg1.4
  'view_log_explanation' => 'Coppermine sokféle felhasználói műveletet tud rögzíteni. A naplók közt keresgélhetünk, ha  a naplózás engedélyzve van a<a href="admin.php">Beállítások</a> -ban.', //cpg1.4
...
if (defined('VERSIONCHECK_PHP')) $lang_versioncheck_php = array(
  ...
  'what_it_does' => 'Ez az oldal jelentést ad azon felhasználóknak, akik frissítették a programjukat. Ez a eljárás ellenőrzi, hogy a webszerveren található fájlok verziója megegyezik-e http://coppermine.sourceforge.net webhelyen találhatókkal. Ígí áttekintés kapunk a frissítés sikerességéről.<br />Pirossal azokat mutatja, melyeket muszály cserélni újabbra. Sárgával azokat melyeket ajánlott cserélni. Zölddel (vagy az alapértelmezett betüszínnel) azokat mutatja amely fájlok legújabb verziójuak.<br />Kattints az ikonra a részletekért.', //cpg1.4
  ...
  'online_repository_reason2' => 'A PHP  %s beállítás a böngésződben ki van kapcsolva (Alapértelmezetten bekapcsolva van). Ha rendszergazdája vagy a webszervernek akkor kapcsold be a<i>php.ini</i>-ben( %s felülírásának engedélyezése). Ha csak webhostolt vagy akkor bele kell törödnöd, hogy nem tudod interneten keresztül ellenőrízni a fájlok frisseségét.Ekkor az oldal csak a telepített fájlok verzióját jeleníti meg.', //cpg1.4
  'online_repository_skipped' => 'A fájlraktárhoz való kapcsolódás kihagyva', //cpg1.4
  'online_repository_to_local' => 'A program a jelenlegi fájl verziókat veszi alapértelmezetnek. Az adatok pontatlanokká válnak, ha a Coppermine frissítésekor nem sikerül az összes fájlt feltőlteni. Ekkor nem tud minden fájl a megfelő kiadású lenni.', //cpg1.4
  'local_repository_unable' => 'Nem lehet a helyi fájlraktárhoz kapcsolódni', //cpg1.4
  'local_repository_explanation' => 'Coppermine nem tud a(z) %s fájlraktárhoz kapcsolódni a szerveren. Ez azt jelenti, hogy a raktárkészlet fájl nem lett feltöltve. Probáld meg az oldlat újra futattni (Kattits a "frissítés"-re).<br />A hibát jelezz, akkor a webhostodon letiltva vannak a webelemek számára a <a href="http://www.php.net/manual/de/ref.filesystem.php">PHP fájlműveletek</a> . Ez esetben sajnáljuk, de nem használhatod ezt az eszközt.', //cpg1.4
  'coppermine_version_header' => 'Telepített Coppermine-Verzió', //cpg1.4
  'coppermine_version_info' => 'Jelenleg telepített: %s', //cpg1.4
  'coppermine_version_explanation' => 'Ha szerinted hibás a megjelent adat, akkur lehet, hogy nem lett feltöltve a legfrisseb adatokat tartalmazzó <i>include/init.inc.php</i> fájl', //cpg1.4
  ...
  'help_no_local_version2' => 'Nem lehet meghatározni a fájl verzióját.A fájl régi vagy módosítva lett esetleg eltávólították a fejlécét. Ajánlott a frissítése', //cpg1.4
  'help_local_version_outdated1' => 'Lejárt a fájl verziója', //cpg1.4
  'help_local_version_outdated2' => 'Ezzen fájl valószinűleg egy régebbi Coppermine verzióhoz tartozik.Bizonyosodj meg, hogy nincs-e ujabb nála.', //cpg1.4
  'help_local_version_na1' => 'Nem lehet meghatározni a CVS adatokat', //cpg1.4
  'help_local_version_na2' => 'A program nem tudja eldönteni a CVS-Verzió adatokat a webszerver fájljaíról. A fájlokat felrakhatod csomagból.', //cpg1.4
  'help_local_version_dev1' => 'Fejlesztői verzió', //cpg1.4
  'help_local_version_dev2' => 'A fájlok a webszerveren újabbak mint a  Coppermine-Verziód. Ez azért lehet, mert fejlesztői változatott használsz vagy frissítés után nem töltöted fel a include/init.inc.php fájlt.', //cpg1.4
  ...
  'help_writable2' => 'A %s könyvtár írható. Ez felesleges biztonsági rés, Coppermine programnak csak olvasási és futtatási jog kell.', //cpg1.4
  ...
  'total' => 'Összes fájl/mappa ellenőrízva', //cpg1.4
  'mandatory_files_missing' => 'Hiányzó szükséges fájlok', //cpg1.4
  'optional_files_missing' => 'Hiányzó opcionális fájlok', //cpg1.4
  'files_from_older_version' => 'Régebbi verzióju fájlok', //cpg1.4
  'file_version_outdated' => 'Lejárt verzióju fájlok', //cpg1.4
  ...
  'show_errors_only' => 'Csak a hibások megjelenítése', //cpg1.4
  ...
  'stable_webcvs_link' => 'A Web-CVS-Linkek  megjelnítése a "végleges állapot" részben', //cpg1.4
  'devel_webcvs_link' => 'A Web-CVS-Linkek megjelenítése a "fejlesztői állapot" részben', //cpg1.4
...
if (defined('VIEWLOG_PHP')) $lang_viewlog_php = array(
  ...
  'delete_this' => 'Ezzen napló törlése', //cpg1.4
...
<h1>XP Web közététel varázsló</h1><p>Ez a modul lehetővé teszi a  <b>Windows XP</b> web közététel varaázsló használatát a coppermine képtárral.</p><p>A kód újságcikkre alapul, beküldte:
EOT;
...
Válazd a &quot;Mentés másként..&quot; pontot. Mentsd le a helyi lemezre. A lementés után ellenőrízd, hogy a fájlnév  <b>cpg_###.reg</b> (A ###-időbélyeget mutat). Kattint kettőt a fájlra, hogy regisztráld a szervered a webes közététel varaázsló számára.</li></ul>
EOT;

$lang_xp_publish_testing = <<<EOT
<h2>Próba</h2><ul><li>A windows intézőjében válassz ki néhány képet és kattints a <b>xxx közététele a weben</b> menüre a bal-panelen</li><li>Erősítsd meg a kiválasztásokat, majd kattints a <b>következő</b>-re.</li><li>A megjelenő listából válasszd ki a fotóképtárat (a neve a te Képtárad neve). Ha nem látszik a listában, akkor ellenőrízd, hogy telepítve van a <b>cpg_pub_wizard.reg</b> a fent leírtak szerint.</li><li>Add meg a bejelentkezési információkat, ha szükséges.</li><li>Válasz cél alubumot a képek számára vagy hozzál létre újat.</li><li>Kattints a <b>tovább</b>-ra. A feltöltés elkezdődik.</li><li>A befejeződik a feltöltés, ellenőrizd, hogy a képek rendben bekerültek a képtárba.</li></ul>
EOT;

$lang_xp_publish_notes = <<<EOT
<h2>Anmerkungen :</h2><ul> Ha a feltöltés elindult, akkor a program már nem tudd hibaüzeneteket megjeleníteni, ezér addig nem tudod, hogy sikeres volt-e a feltöltés , amig nem nézed meg a képtárban.</li><li>Ha sikertelen volt akkor, engedélyezd a &quot;Debug-Módquot;-ot a képtár rendszergazdai oldalán, majd 1 képpel probálkoz újra, és nézd meg a hibaüzenetet a
EOT;

$lang_xp_publish_flood = <<<EOT
A fájl ami szervered Coppermine könyvtárában található.</li><li>Hogy elkerüljük a képtár támadását a képfeltöltő varázslón keresztül, csak a képtár rendszergazdái és azok a felhasználók akik saját albummal rendelkeznek, használhatják ezt a funkciót</li>
EOT;
...
$lang_xp_publish_php = array(
  ...
  'need_login' => 'Szükséges bejelentkezned a képtárba a böngésződet használva, mielött használnád a varázslót.<p/><p>Bejelentkezéskor nem felejts el bejelölni a &quot;<b>Emlékezz rám</b>&quot; opciót.', //cpg1.4
  'no_alb' => 'Sajnáljuk, de nincs egy album se ahova feltudnál tölteni képet a varázslóval.', //cpg1.4
