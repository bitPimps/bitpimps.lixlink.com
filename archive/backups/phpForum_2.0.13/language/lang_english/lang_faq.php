...
// Begin My Added FAQ
$faq[] = array("How do I make an Image a clickable Link?", "Wrap the BBCode [url] tag around the BBCode [img] tag like normal. For more information on BBCode see the guide which can be accessed from the posting page.");
// End My Added FAQ
...
// My Added FAQs & FGAs
$faq[] = array("--","General Site Information");
$faq[] = array("What the hell is this site about?", "Simple. Entertainment, education, sharing, and most of all fun.");
$faq[] = array("Are there any rules or guidelines?", "Yes. <a href=\"viewforum.php?f=28\">Click here to read them.</a>");
$faq[] = array("What are the little figures I keep seeing in all these pictures?", "They're called \"Homies\" and you can get them from several places:<ul><li>In this forum under <a href=\"index.php?c=4\">bitPimps Flea-Market</a>. People trade, buy and sell them under these forum catagories.</li><li>Gumball machines at some stores like Toys R Us, some hobby shops and other places that have cool gumball machine items.</li><li>Online at homies.tv, ebay.com, and a few other online shops.</li></ul>");
$faq[] = array("What if I want to make a donation, by either donating something as a prize or sending money to help pay the hosting bills?", "You can contact <strong>CaboWabo</strong> on the <a href=\"index.php\">Forums</a> via a Private Message, e-mail, or by posting in the <a href=\"viewtopic.php?t=5210\">FAQs & FGAs / Rules -> Where would I send prizes?</a> thread.");
