...
Extended Comment Options also allows you to exclude certain posts. So, for example, if you want to close posts older than 5 days, but you have a popular post that draw a lot of comments, you can opt to leave it alone. You can enter as many posts as you'd like.

== Installation ==

1. Extract the files. Upload `commentcontrol.php` to the `/wp-content/plugins/` directory. This is the only file you need, don't upload any of the others.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. That's it! Once the plugin is activated there is a new page on the comments tab which contains all the options.
...
= What about WordPress version 1.5? =

There is a version of Extended Comment Options available for WordPress version 1.5 from the Plugin Homepage.

== Screenshots ==

1. Simple Settings. These options can be set quickly, with minimal clicks.
2. Advanced settings. These allow more control over what the plugin does.