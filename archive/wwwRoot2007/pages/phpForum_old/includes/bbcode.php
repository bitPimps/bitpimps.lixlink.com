...
function Multi_BBCode()
{
	...
	$EMBB_values = array('','GVideo','YouTube') ;
...
function prepare_bbcode_template($bbcode_tpl)
{
	...
	$bbcode_tpl['YouTube'] = str_replace('{YOUTUBEPREFIX}', '\\1', $bbcode_tpl['YouTube']);
	$bbcode_tpl['YouTube'] = str_replace('{YOUTUBESUFFIX}', '\\2', $bbcode_tpl['YouTube']);
...
function bbencode_second_pass($text, $uid)
{
  ...
  $patterns[] = "#\[YouTube\]http://(www\.|it\.|co\.|uk\.|ie\.|br\.|pl\.|jp\.|fr\.|es\.|nl\.)?youtube.(com|it|co\.uk|ie|br|pl|jp|fr|es|nl)/watch\?v=([0-9A-Za-z-_]{11})[^[]*\[/YouTube\]#is";
