...
*
* @package language
* @version $Id: board.php 10430 2010-01-19 19:08:51Z bantu $
...
$lang = array_merge($lang, array(
  ...
  'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'Number of items per page to display in the forums feed', // DELETE

  'ACP_FEED_OVERALL_TOPIC'			=> 'Enable topics feed', // DELETE
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Enables the “All Topics” feed, which displays the last created topics including the first post.', // DELETE
  'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'Number of items per page to display in the topics feed', // DELETE
