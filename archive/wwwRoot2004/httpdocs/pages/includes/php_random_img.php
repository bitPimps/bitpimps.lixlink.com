...
if (isset($imgType))
{
  ...
  elseif($imgType == "four")
	...
	elseif($imgType == "fortysix")
		$hpImg = 46; // multishot37.jpg
	elseif($imgType == "fortyseven")
		$hpImg = 47;
	elseif($imgType == "fortyeight")
		$hpImg = 48;
	elseif($imgType == "fortynine")
		$hpImg = 49;
	elseif($imgType == "fifty")
		$hpImg = 50;
	elseif($imgType == "fiftyone")
		$hpImg = 51;
	elseif($imgType == "fiftytwo")
		$hpImg = 52;
	elseif($imgType == "fiftythree")
		$hpImg = 53;
	elseif($imgType == "fiftyfour")
		$hpImg = 54;
	elseif($imgType == "fiftyfive")
		$hpImg = 55;
	elseif($imgType == "fiftysix")
		$hpImg = 56;
	elseif($imgType == "fiftyseven")
		$hpImg = 57;
	elseif($imgType == "fiftyeight")
		$hpImg = 58;
	elseif($imgType == "fiftynine")
		$hpImg = 59;
}
