...
<html>
<head>
<title><?php echo $board_config['sitename']; ?> Portal</title>
...
<tr>
<td style="background-image:url('<?php echo $phpbb_root_path; ?>mods/phpbb_fetch_all/examples/header_bg.png'); background-repeat:repeat-x;" width="100%" valign="top"><span class="maintitle"><?php echo $board_config['sitename']; ?> Portal</span><br /><span class="gen"><?php echo $board_config['site_desc']; ?></span></td>
</tr>
</table>
...
<input type="checkbox" name="autologin" /> <?php echo $lang['Log_me_in']; ?><p />
<?php
   //
...
<div align="center"><input type="submit" class="mainoption" name="login" value="<?php echo $lang['Login']; ?>" /><p />
