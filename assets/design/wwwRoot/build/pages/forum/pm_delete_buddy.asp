...
strSQL = "DELETE FROM tblBuddyList WHERE (((tblBuddyList.Author_ID)="  & lngLoggedInUserID & " ) AND ((tblBuddyList.Address_ID)= " & CLng(Request.QueryString("pm_id")) & "));"
...
Response.Redirect "pm_buddy_list.asp"
%>