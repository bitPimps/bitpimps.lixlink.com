...
If Request.QueryString("mode") = "reactivate" Then
	Response.Write(strTxtYourEmailAddressHasBeenChanged)
'Else welcome the new member
Else
	Response.Write(strTxtThankYouForRegistering)
End If
  %><br>
 <br>
 <br>
...
'If this is a re-activation then tell the member
If Request.QueryString("mode") = "reactivate" Then
 	Response.Write(strTxtYouShouldReceiveAReactivateEmail)
'Else welcome the new member
Else
 	Response.Write(strTxtYouShouldReceiveAnEmail) 
End If	
 	%></span><br>
 <br>
 <br>
 <% = strTxtIfErrorActvatingMembership %><br>
</span></div> 
<br>
  <br>
  <br>
