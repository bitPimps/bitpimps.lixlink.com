...
strSQL = "SELECT tblTopic.* FROM tblTopic WHERE tblTopic.Forum_ID ="  & intForumID & ";"
...
strSQL = "DELETE FROM tblModerator WHERE tblModerator.Forum_ID ="  & intForumID & ";"
...
strSQL = "DELETE FROM tblTopic WHERE tblTopic.Forum_ID ="  & intForumID & ";"
...
'Delete the forum
strSQL = "DELETE FROM tblForum WHERE tblForum.Forum_ID ="  & intForumID & ";"
