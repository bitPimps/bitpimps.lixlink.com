...
<div align="center"><a href="admin_menu.asp" target="_self"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Return to the the Administration 
 ...
 <br>
 Archive Topics that have not been posted in for sometime by locking them so they can no-longer be posted in.<br>
 <br>
 Select the Topics you want archived by Forum and when a posts was last posted in them.<br>
 </font></div>
<form method="post" name="frmChangePassword" action="archive_topics.asp" onSubmit="return confirm('Are you sure you want to achive these topics?')">
 <table width="700" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#000000" height="8">
  <tr> 
   <td height="24"> 
    <table border="0" align="center"  height="8" cellpadding="4" cellspacing="1" width="100%">
     <tr bgcolor="#CCCCCC" > 
      <td align="left" width="51%" height="2" class="text"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Archive Topics in</font></b></td>
      <td height="2" width="49%" class="text"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Archive Topics that haven't been posted for</font></b></td>
     </tr>
     <tr bgcolor="#FFFFFF"> 
      <td align="left" width="51%"  height="12"> 
       <select name="ForumID">
...
%>
      ...
      <td height="12" width="49%" valign="top"> 
       <select name="days">
 ...
 <div align="center"><br>
  <input type="submit" name="Submit" value="Archive Topics">
 </div>
</form>
<br>
</body>
