...
<h1 align="center"><font face="Arial, Helvetica, sans-serif">Remove Web Wiz Guide Link Buttons</font></h1>
<div align="center"> 
 <p><a href="admin_menu.asp" target="_self"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Return to the the Administration Menu</font></a><br>
  ...
  <br>
  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">Thank-you for your donation to Web Wiz Guide, the links should now be removed from the forum.<br>
  <br>
  ...
  <% Else %>
  <br>
  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">As part of the license for Web Wiz Forums you are required to leave Powered By<br>
  </font><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Web Wiz Guide links in place. I believe that this is a small price to pay for the many months<br>
  of ongoing time that have gone into the development and support of the Forum.<br>
  <br>
  However, many people have asked if they can remove these links for various reasons so <br>
  I am asking for a small donation of any amount you like to help me cover some of the costs <br>
  involved in the many 1,000's of hours of ongoing development, support, and distribution <br>
  of this and other free applications and services from Web Wiz Guide.<br>
  <br>
  For more information or to find out how you can make a donation to Web Wiz Guide click on the link below: -<br>
  <br>
  <a href="http://www.webwizguide.info/donations/forum_donation.asp" target="_blank">Click here to make a donation to Web Wiz Guide and receive the link removal code</a> <br>
  </font><br>
 </p>
 </div>
<%
